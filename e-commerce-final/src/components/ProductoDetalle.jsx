  ...
  return (
    <div className="detalle-container">
      ...
      <div className="detalle-info">
        ...
        {admin ? <Link to={"/admin/editarProducto/" + id}> <Button variant="secondary" >Editar Producto</Button></Link> : <Button onClick={funcionCarrito} variant="secondary">Agregar al carrito</Button> }
